...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # internet says by itself, never - when surrounded by other things that do not exist
    # then it can fail
    assert_equal nil, 'abcd'[/a*z/]
  end
  ...
  # Why?
  #
  # they return the first match; not the longest/best/etc... match
  ...
  # it's faster as it does not have to backtrack
