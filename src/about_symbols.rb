...
class AboutSymbols < Neo::Koan
  ...
  # you don't want to risk introducing a new symbol that will then exist,
  # it's safer to not risk polluting the global symbols table
  ...
  def test_symbols_do_not_have_string_methods
    string = 'a string'
    assert_equal true, string.respond_to?(:each_char)
    assert_equal true, string.respond_to?(:reverse)
  ...
  #
  # The memory is only freed once the program dies
end
